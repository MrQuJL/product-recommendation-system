...
<head>
	...
	<title>新增图片</title>
	<!--[if lt IE 9]>
	<script type="text/javascript" src="${ctxJsAndCss}/js/html5.js"></script>
	<script type="text/javascript" src="${ctxJsAndCss}/js/respond.min.js"></script>
	<script type="text/javascript" src="${ctxJsAndCss}/js/PIE_IE678.js"></script>
	<![endif]-->
	...
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/My97DatePicker/WdatePicker.js"></script> 
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/icheck/jquery.icheck.min.js"></script> 
	 <script type="text/javascript" src="${ctxJsAndCss}/Widget/zTree/js/jquery.ztree.all-3.5.min.js"></script> 
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/Validform/5.3.2/Validform.min.js"></script> 
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/webuploader/0.1.5/webuploader.min.js"></script>
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/ueditor/1.4.3/ueditor.config.js"></script>
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/ueditor/1.4.3/ueditor.all.min.js"> </script>
	<script type="text/javascript" src="${ctxJsAndCss}/Widget/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script> 
    ...
    $(function() {
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            // 压根就没有安转。
                ...
                $wrap.html('<a href="http://www.htmlsucai.com" target="_blank" border="0"><img alt="get flash player" src="http://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" /></a>');
            }
