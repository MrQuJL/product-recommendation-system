	...
	<div class=" page-content clearfix">
		<div id="products_style">
			...
			<div class="border clearfix">
				<span class="l_f">
					<a href="${ctx}/sysmgr/product/gotoProductEdit" title="添加商品"
						class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品
					</a>
				...
				<table class="table table-striped table-bordered table-hover"
					...
					<tbody>
						...
						<tr>
							...
							<td width="80px">45631</td>
							<td width="250px"><u style="cursor: pointer"
								class="text-primary" onclick="">小米s Max 全网通 高配版 3GB内存 64GB
									ROM 金色 移动联通电信4G手机Y</u></td>
							<td width="100px">5467</td>
							<td width="100px">4525</td>
							<td width="180px">2014-6-11 11:11:42</td>
